...
public class UsuarioDAOImpl implements UsuarioDAO {
     ...
     * @return @return Regresa {@code true} si se agregó correctamente a la tabla de usuarios
     ...
     * @returnRegresa {@code true} si el contacto se pudo eliminar y {@code false} en caso
